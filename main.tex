...
\begin{enumerate}[(i)]
	...
	\]
	where $\tau$ is any subrepresentation of $R_{T,\theta}$. By \Cref{thm:KondoClassical}, this only depends on geometric conjugacy class of $(T,\theta)$ hence the semisimple conjugacy class of $(s_{T,\theta})$.
...
By \Cref{lem:indep_geo_conj}, we know that for $R_T(\theta) = \sum_{\pi} c_{\pi} \pi$, 
