...
\begin{center}
	\begin{tabular}{|c|c|} \hline
		$\algebraicGroup{G}$ & $\rho \colon \algebraicGroup{G}^{\ast} \to \left(\restrictionOfScalars{\quadraticExtension}{\finiteField}{}\right) \algebraicGroup{\GL}_N$  \tabularnewline \hline \hline
	...
	\end{tabular}
\end{center}
In each of the cases in the table, the map on cocharacters $\rho_{\ast}:\CocharacterLattice{\algebraicGroup{T}^{\ast}} \cong (\mathbb{Q}/\mathbb{Z})_{p'}^n \to \CocharacterLattice{\tilde{\algebraicGroup{T}}^{\ast}} \cong (\mathbb{Q}/\mathbb{Z})_{p'}^{2n}$ sends $x$ to $(x,-w_n x)$. \calvin{in the GSpin cases might scale up by 2}
