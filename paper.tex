...
\begin{proposition}
	...
	\begin{align*}
		 \dblVirtualGaussSumScalar{R_{T, \theta}}{\chi} =& R_{T,\theta}\left(1\right) \GaussSumScalar{\chi^2}{\fieldCharacter}^{\lfloor\frac{\dim \hermitianSpace}{2}\rfloor} g_T\left(\theta, \fieldCharacter\right) \\
