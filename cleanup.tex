...
\begin{definition}
    ...
    The pairs $(T',\theta'),(T,\theta)$ are said to be \emph{geometrically conjugate} is the geometric conjugacy classes $(s_{T,\theta})$ and $(s_{T,\theta'})$ are equal.
...
\begin{tabular}{ c c}
 ...
 $\UnitaryGroup_n$  & $\UnitaryGroup_n \to \GL_{2n}$  
\end{tabular}
\end{center}
